...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/instituto/logo.jpeg" rel="icon">
  ...
  <header id="header" class="fixed-top">
    <div class="container">
      ...
      <div class="logo float-left">
        <a href="index.php"><img src="assets/img/instituto/logo.jpeg" alt="" class="img-fluid"></a>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Primer semetre</li>
              <li data-filter=".filter-card">Segundo semestre</li>
              <li data-filter=".filter-web">Tercer semestre</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 filter-app">
            <div class="portfolio-item">
              <img src="assets/img/instituto/laptop.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a href="assets/img/instituto/laptop.jpg" data-gall="portfolioGallery" class="venobox" title="App 1">Liderazgo</a></h3>
                <div>
                  <a href="assets/img/instituto/laptop.jpg" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="icofont-eye"></i></a>
                  <a href="portfolio-details.php" title="Details"><i class="icofont-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 filter-web">
            <div class="portfolio-item">
              <img src="assets/img/instituto/tasas.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a href="assets/img/instituto/tasas.jpg" data-gall="portfolioGallery" class="venobox" title="Web 3">Finanzas bancarias</a></h3>
                <div>
                  <a href="assets/img/instituto/tasas.jpg" data-gall="portfolioGallery" class="venobox" title="Web 3"><i class="icofont-eye"></i></a>
                  <a href="portfolio-details.php" title="Details"><i class="icofont-plus"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 filter-app">
            <div class="portfolio-item">
              <img src="assets/img/instituto/contador.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a href="assets/img/instituto/contador.jpg" data-gall="portfolioGallery" class="venobox" title="App 2">Balance general</a></h3>
                <div>
                  <a href="assets/img/instituto/contador.jpg" data-gall="portfolioGallery" class="venobox" title="App 2"><i class="icofont-eye"></i></a>
                  <a href="portfolio-details.php" title="Details"><i class="icofont-plus"></i></a>
                </div>
              </div>
            </div>
...
<!-- 
    ...
    </section><!-- End Our Perfil profesional -->
